...
# (summary file, panel label, title with qubit count, min bond length or None)
CASES = (
    ("HF_bond_scan_summary.txt", "a", r"HF 8Q", 0.8),
    ("Cl2_bond_scan_summary.txt", "b", r"Cl$_2$ 10Q", 1.6),
    ("Br2_bond_scan_summary.txt", "c", r"Br$_2$ 12Q", None),
)
...
def main() -> None:
    ...
    for ax, (fname, letter, title, min_bond) in zip(axes, CASES):
