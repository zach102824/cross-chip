...
Results are written under data/shots_<N>/Br2_bond_<R>/. Override bond length with
...
N_ACTIVE_ELECTRONS = 10              # active electrons
N_SPATIAL_ORBITALS = 6             # active spatial orbitals
N_QUBITS = 2 * N_SPATIAL_ORBITALS  # spin-orbitals == qubits
ETA = N_ACTIVE_ELECTRONS // 2      # occupied spatial orbitals per spin sector

# 8-entry HF-era template; resized to N_QUBITS (12 for Br2) by repeating as needed.
...
CIRCUIT_NAME = "Br2_12q_4doubles_rzx"
...
CROSS_CHIP_QUBIT_PAIRS = {(4, 10),(1,2),(7,8)}
