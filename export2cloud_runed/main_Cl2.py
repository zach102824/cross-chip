...
Results are written under data/shots_<N>/Cl2_bond_<R>/. Override bond length with
...
# 8-entry HF-era template; resized to N_QUBITS (10 for Cl2) by repeating as needed.
